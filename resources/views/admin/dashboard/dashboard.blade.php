...
@section('footer_js')
    {!! Html::script('st-admin/vendors/Chart.js/dist/Chart.min.js') !!}
    {!! Html::script('st-admin/vendors/jquery-sparkline/dist/jquery.sparkline.min.js') !!}
    {!! Html::script('st-admin/vendors/raphael/raphael.min.js') !!}
    {!! Html::script('st-admin/vendors/morris.js/morris.min.js') !!}
    {!! Html::script('st-admin/vendors/gauge.js/dist/gauge.min.js') !!}
    {!! Html::script('st-admin/vendors/skycons/skycons.js') !!}
    {!! Html::script('st-admin/vendors/Flot/jquery.flot.js') !!}
    {!! Html::script('st-admin/vendors/Flot/jquery.flot.pie.js') !!}
    {!! Html::script('st-admin/vendors/Flot/jquery.flot.time.js') !!}
    {!! Html::script('st-admin/vendors/Flot/jquery.flot.stack.js') !!}
    {!! Html::script('st-admin/vendors/Flot/jquery.flot.resize.js') !!}
    {!! Html::script('st-admin/vendors/flot.orderbars/js/jquery.flot.orderBars.js') !!}
    {!! Html::script('st-admin/vendors/flot-spline/js/jquery.flot.spline.min.js') !!}
    {!! Html::script('st-admin/vendors/flot.curvedlines/curvedLines.js') !!}
    {!! Html::script('st-admin/vendors/DateJS/build/date.js') !!}
@endsection

							...
							<div class="x_panel">
								<div class="col-xs-9">
									...
									<div class="form-group">
										...
										<textarea class="ckeditor form-control" name="content" id="content" rows="5"></textarea>
										<script>
								...
								<div class="col-xs-3">
									...
									<div class="form-group">
										...
										{!! Form::text('name', '', array('class' => 'form-control', 'placeholder' => 'Course name')) !!}
									</div>

									<div class="form-group">
										<label>Share url</label>
										{!! Form::text('share_url', '', array('class' => 'form-control', 'placeholder' => 'Share url')) !!}
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group date" id="publish_time">
											{!! Form::text('publish_time', '', array('class' => 'form-control datepicker', 'placeholder' => 'Publish time')) !!}
									...
									<div class="form-group">
										...
										{!! Form::text('price', '', array('class' => 'form-control', 'placeholder' => 'Tuition fee')) !!}
									</div>

									<div class="form-group">
										<label>Tuition fee old</label>
										{!! Form::text('price_old', '', array('class' => 'form-control', 'placeholder' => 'Tuition fee old')) !!}
									</div>

									<div class="form-group">
										<label>Start sale</label>
										<div class="input-group date" id="start_sale">
											{!! Form::text('start_sale', '', array('class' => 'form-control datepicker', 'placeholder' => 'Start sale')) !!}
											<span class="input-group-addon">
											   <span class="glyphicon glyphicon-calendar"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="input-group date" id="end_sale">
											{!! Form::text('end_sale', '', array('class' => 'form-control datepicker', 'placeholder' => 'End sale')) !!}
											<span class="input-group-addon">
											   <span class="glyphicon glyphicon-calendar"></span>
											</span>
										</div>

...
class CategoryProductController extends Controller
{
    ...
    public function productIndex()
    {
        ...
        return view('admin.category-product.index')->with(compact('categories'));
    }
    ...
    public function productAdd()
    {
        ...
        return view('admin.category-product.form-category')->with(compact('categories'));
    }
    ...
    public function productEdit($id)
    {
        ...
        return view('admin.category-product.edit-category')->with(compact('category', 'categories'));
    }
